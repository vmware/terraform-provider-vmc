...
*Note:* This project has a dependency on another go module (https://github.com/vmware/vsphere-automation-sdk-go) which is not public yet. This provider will not be usable without that module.  We are working on it and will update this README when the issue is resolved.
