...
* `nsxt_reverse_proxy_url` - (Required) NSXT reverse proxy url for managing public IP.
...
* `nsxt_reverse_proxy_url` - NSXT reverse proxy url computed after SDDC creation.
