...
For deployment_type SingleAZ,The sddc_type can be 1NODE with num_host argument set to 1 for a Single host SDDC. The sddc_type for 2Node (num_host = 2) and 3 or more nodes is "DEFAULT". 
