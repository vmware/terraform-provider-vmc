...
// PagedResponseOfOrganizationDto struct for PagedResponseOfOrganizationDto
type PagedResponseOfOrganizationDto struct {
	...
	// List of results
	Results []OrganizationDto `json:"results,omitempty"`
}
