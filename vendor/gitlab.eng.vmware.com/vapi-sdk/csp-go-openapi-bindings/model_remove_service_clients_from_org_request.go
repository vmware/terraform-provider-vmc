...
// RemoveServiceClientsFromOrgRequest struct for RemoveServiceClientsFromOrgRequest
type RemoveServiceClientsFromOrgRequest struct {
	// The service definition ID
	ServiceDefinitionId string `json:"serviceDefinitionId,omitempty"`
	// Client IDs to be deleted
