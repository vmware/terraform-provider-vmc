...
// PagedResponseOfExpandedAuthClientDto struct for PagedResponseOfExpandedAuthClientDto
type PagedResponseOfExpandedAuthClientDto struct {
	...
	// List of results
	Results []ExpandedAuthClientDto `json:"results,omitempty"`
}
