...
// SearchGroupsByRolesRequest Search groups by roles
type SearchGroupsByRolesRequest struct {
	RolesSearchTerm RolesSearchTermDto `json:"rolesSearchTerm,omitempty"`
	// Maximum number of groups to return in response. Default value is 200
	PageLimit int32 `json:"pageLimit,omitempty"`
	// Start index for querying groups. Default value is 1
