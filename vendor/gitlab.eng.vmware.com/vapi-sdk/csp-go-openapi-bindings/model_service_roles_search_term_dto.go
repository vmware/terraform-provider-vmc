...
// ServiceRolesSearchTermDto struct for ServiceRolesSearchTermDto
type ServiceRolesSearchTermDto struct {
	ServiceDefinitionId string `json:"serviceDefinitionId"`
	ServiceRoles []ServiceRoleSearchTermDto `json:"serviceRoles"`
}
